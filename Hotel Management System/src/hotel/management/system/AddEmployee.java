...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String job = (String) cbjob.getSelectedItem(); // type cast in string as it selects object
        ...
        try{
            ...
            c.s.executeUpdate(query) ; // executeUpdate used to update data
            
            JOptionPane.showMessageDialog(null, "Empoyee added succesfully") ;
